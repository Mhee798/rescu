...
class DealCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // The whole card is inside the `ExpiryBuilder` because the whole card
    // changes when the sale ends — it stops being tappable and reads as
    // expired. That is one rebuild, at the crossing. The per-second part is
    // the `FlashSaleCountdown` in the badge, and it is the only thing in here
    // that rebuilds on a tick.
